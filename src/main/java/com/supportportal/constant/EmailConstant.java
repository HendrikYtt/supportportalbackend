...
public class EmailConstant {
    ...
    public static final String USERNAME = "examplecompany222@gmail.com";
    public static final String PASSWORD = "vahipataljonValvel123";
    public static final String FROM_EMAIL = "support@getarrays.com";
    public static final String CC_EMAIL = "";
    public static final String EMAIL_SUBJECT = "Example Company, LLC - New Password";
